...
<div id="Detailpopup" class="Pstyle">
	...
	<div class="content">
		<form id="DetailForm" name="DetailForm" action="detailbranchoffice_store_CS" method="POST">
			<input type="hidden"   name="${_csrf.parameterName}" value="${_csrf.token}"/>
				...
				<table id ="pop_layout">
					...
					<tr>
						<td>연락처1 : </td>
						<td><input type="text" name="s_tel1" value="" readonly="readonly" style="border:none; width:300px;"></td>
					</tr>
					<tr>
						<td>연락처2 : </td>
						<td><input type="text" name="s_tel2" value="" readonly="readonly" style="border:none; width:300px;"></td>
					</tr>
					<tr>
						<td>로그인 계정 : </td>
					...
					<tr>
						<td >가맹점 주소1 : </td>
						<td><input type="text" name="s_addr1" value="" readonly="readonly" style="border:none; width:500px;"></td>
					</tr>
					<tr>
						<td >가맹점 주소2 : </td>
