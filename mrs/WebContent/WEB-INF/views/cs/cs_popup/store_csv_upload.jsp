  ...
  <tr>
    ...
    <div class="COMMON_POPUP_BODY" id="USER_ID01">
        <table width="370" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>
            <form name="fileForm" id="fileForm" action="store_csv_insert_CS?${_csrf.parameterName}=${_csrf.token}"  method="POST"  enctype="multipart/form-data">
                ...
                <table width="370" border="0" cellspacing="1" cellpadding="5" bgcolor="#E5E5E5">
                  <tr>                                                                           
                    ...
                    <td bgcolor="#F9F9F9" class="11px_txt_b" align="center" height="50">         
                    	파일명(CSV파일)<br/>                                                         
                     CSV Sample : <a href="sample_csv_CS?${_csrf.parameterName}=${_csrf.token}">(Sample download)</a>    
