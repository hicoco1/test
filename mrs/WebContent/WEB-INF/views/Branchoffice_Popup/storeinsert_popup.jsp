...
function sample4_execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                //$("#InsertForm").find("input[name=s_addr2]").val(fullRoadAddr);
                $("#InsertForm").find("input[name=s_addr1]").val(data.jibunAddress);
                $("#InsertForm").find("input[name=s_addr_building]").val(data.buildingName);
                ...
                if(data.autoRoadAddress) {
                    ...
                    if(data.jibunAddress == null || data.jibunAddress == '') {
                    	$("#InsertForm").find("input[name=s_addr1]").val(expJibunAddr);
                    }else {
                    	$("#InsertForm").find("input[name=s_addr1]").val(data.jibunAddress);
                    }
                ...
                $("#InsertForm").find("input[name=s_addr_appendix]").focus();
...
<div id="Insertpopup" class="Pstyle">
	...
	<div class="content">
		<form id="InsertForm" name="InsertForm" action="insertbranchoffice_store" method="POST">
			<input type="hidden"   name="${_csrf.parameterName}" value="${_csrf.token}"/>
			<input type="hidden" name="action" />
			<input type="hidden" name="addr_chk_flag" value="0"/>
				<table>
					<tr>
				...
				<table id ="pop_layout">
					...
					<tr>
						<td >기사 도착 제한 시간 : </td>
						<td><input type="text" name="cook_time"  class="input_click_init" value="15" maxlength="3" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' style='ime-mode:disabled;'>&nbsp;분</td>
					</tr>
					<tr>
					...
					<tr>
						<td >사업자 번호 : </td>
						<td><input type="text" name="s_crn" id="s_crn" value="" maxlength="12" onkeyup="this.value=number_filter(this.value);"></td>
					</tr>
					<tr>
				...
				<tr>
					...
					<tr>
						<td >기준 거리 : </td>
						<td><input type="text" name="basic_distance" class="input_click_init" value="2500" maxlength="5" onkeydown='return onlyNumber(event)' onkeyup='removeChar(event)' style='ime-mode:disabled;'>&nbsp;m</td>
					</tr>
					<tr>
						<td >기본 요금 : </td>
