...
<div id="Updatepopup" class="Pstyle">
	<span class="b-close">X</span>
		<div class="content">
		<form id="UpdateForm" name="UpdateForm" action="updatebranchoffice_addr" method="POST">
				...
				<table id ="pop_layout">
					<tr>
						...
						<c:if test="${!empty list_bid}" >
							<select name="b_id" id="b_id" style="width:80px;" class="required" title="지점 ID를 선택해 주세요.">
					...
					<tr>
						<td >지점 이름 : </td>
						<td><input type="text" name="b_name" value="" maxlength="20" style=" width:100px;" readonly="readonly"></td>
					</tr>
					<tr>
						<td>기존 지번 주소 : </td>
