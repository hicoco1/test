...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if(lasturl == 'His_main' || lasturl == 'His_branch' || lasturl == 'His_cardfail'){
			$("a").each(function(){			
				if($(this).attr("href") == 'His_main' ||  $(this).attr("href") == 'His_branch' ||  $(this).attr("href") == 'His_cardfail'){
...
<div class="leftMain">
	<div id='cssmenu'>
		<ul>
			...
			<hr color="#87CEFA" />
			<li><a href="His_branch"><span id="font_little">지점 충전 이력</span></a></li>
			<li><a href="His_main"><span id="font_little">업소 충전 이력</span></a></li>
			<li><a href="His_cardfail"><span id="font_little">카드 결제 실패 이력</span></a></li>
			<hr color="#87CEFA" />
		</ul>
	</div>
</div>
